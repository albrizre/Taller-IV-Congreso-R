...
source("Models/Poisson_inhom1.R")
...
Sys.time()
mcmc.output <- nimbleMCMC(Poisson_inhom1, data = data, inits = inits, constants = constants,
                          monitors = monitors_pars, 
                          niter = 20000, nburnin = 10000, nchains = 2, thin = 10,
                          summary = TRUE, WAIC = TRUE)
Sys.time()
save(mcmc.output,file="Outputs/Poisson_inhom1.rda")
